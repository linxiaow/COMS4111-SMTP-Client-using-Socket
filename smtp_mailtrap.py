...
mailserver = "smtp.mailtrap.io"  # use QQ mail
# sender and receiver
fromaddr = "from@example.comm"
toaddr = "to@example.com"

# Authentication encoding using base64
username = base64.b64encode("db5c3c18d1980c".encode()).decode()
password = base64.b64encode("4b0b3fbce2c7a2".encode()).decode()

# Create socket called clientSocket and establish a TCP connection with mailserver

#Fill in start
clientSocket = socket(AF_INET, SOCK_STREAM)
clientSocket.connect((mailserver, 2525))  # mailtrap uses 2525, which may be different
#Fill in end
